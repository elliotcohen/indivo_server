...
urlpatterns = patterns('',
  ...
  (r'^minimal/medicationorders/$', medicationorder_list),
  (r'^minimal/medicationfills/$', medicationfill_list),
  (r'^minimal/medicationadministrations/$', medicationadministration_list),
  (r'^minimal/medicationscheduleitems/$', medicationscheduleitem_list),
  (r'^minimal/equipmentscheduleitems/$', equipmentscheduleitem_list),
  (r'^minimal/schedulegroups/$', schedulegroup_list),
  (r'^minimal/adherenceitems/$', adherenceitem_list),
  (r'^minimal/videomessages/$', videomessage_list),
