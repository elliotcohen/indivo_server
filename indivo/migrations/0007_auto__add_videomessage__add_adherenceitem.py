...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_videomessage', (
            ...
            ('datetime_recorded', self.gf('django.db.models.fields.DateField')(null=True)),
            ('datetime_sent', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        ...
        db.create_table('indivo_adherenceitem', (
            ...
            ('name_type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('name_value', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('reported_by', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('datetime_reported', self.gf('django.db.models.fields.DateField')(null=True)),
            ('adherence', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('nonadherence_reason', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
    ...
    models = {
        ...
        'indivo.adherenceitem': {
            ...
            'name_abbrev': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'name_type': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'name_value': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'nonadherence_reason': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
