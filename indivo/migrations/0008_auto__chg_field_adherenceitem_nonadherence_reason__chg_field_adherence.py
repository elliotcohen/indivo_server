...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdherenceItem.nonadherence_reason'
        db.alter_column('indivo_adherenceitem', 'nonadherence_reason', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'AdherenceItem.name_value'
        db.alter_column('indivo_adherenceitem', 'name_value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'AdherenceItem.name_abbrev'
        db.alter_column('indivo_adherenceitem', 'name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'AdherenceItem.name_type'
        db.alter_column('indivo_adherenceitem', 'name_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'AdherenceItem.nonadherence_reason'
        db.alter_column('indivo_adherenceitem', 'nonadherence_reason', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'AdherenceItem.name_value'
        db.alter_column('indivo_adherenceitem', 'name_value', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'AdherenceItem.name_abbrev'
        db.alter_column('indivo_adherenceitem', 'name_abbrev', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'AdherenceItem.name_type'
        db.alter_column('indivo_adherenceitem', 'name_type', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'indivo.adherenceitem': {
            ...
            'datetime_reported': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        'indivo.videomessage': {
            ...
            'datetime_recorded': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'datetime_sent': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
