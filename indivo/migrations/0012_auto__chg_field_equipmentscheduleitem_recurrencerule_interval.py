...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EquipmentScheduleItem.recurrencerule_interval'
        db.alter_column('indivo_equipmentscheduleitem', 'recurrencerule_interval', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'EquipmentScheduleItem.recurrencerule_interval'
        db.alter_column('indivo_equipmentscheduleitem', 'recurrencerule_interval', self.gf('django.db.models.fields.CharField')(default=0, max_length=200))
