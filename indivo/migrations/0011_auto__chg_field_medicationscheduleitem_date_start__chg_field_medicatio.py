...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MedicationScheduleItem.date_start'
        db.alter_column('indivo_medicationscheduleitem', 'date_start', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 5, 14)))

        # Changing field 'MedicationScheduleItem.recurrencerule_interval'
        db.alter_column('indivo_medicationscheduleitem', 'recurrencerule_interval', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'MedicationScheduleItem.date_scheduled'
        db.alter_column('indivo_medicationscheduleitem', 'date_scheduled', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 5, 14)))


    def backwards(self, orm):
        
        # Changing field 'MedicationScheduleItem.date_start'
        db.alter_column('indivo_medicationscheduleitem', 'date_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'MedicationScheduleItem.recurrencerule_interval'
        db.alter_column('indivo_medicationscheduleitem', 'recurrencerule_interval', self.gf('django.db.models.fields.CharField')(default=0, max_length=200))

        # Changing field 'MedicationScheduleItem.date_scheduled'
        db.alter_column('indivo_medicationscheduleitem', 'date_scheduled', self.gf('django.db.models.fields.DateField')(null=True))
