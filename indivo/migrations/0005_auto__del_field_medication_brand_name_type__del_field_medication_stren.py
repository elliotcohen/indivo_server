...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Medication.datetime_started'
        db.add_column('indivo_medication', 'datetime_started', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Medication.datetime_stopped'
        db.add_column('indivo_medication', 'datetime_stopped', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Medication.order_type'
        db.add_column('indivo_medication', 'order_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.ordered_by'
        db.add_column('indivo_medication', 'ordered_by', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.datetime_ordered'
        db.add_column('indivo_medication', 'datetime_ordered', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Medication.datetime_expires'
        db.add_column('indivo_medication', 'datetime_expires', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Medication.indication'
        db.add_column('indivo_medication', 'indication', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_name'
        db.add_column('indivo_medication', 'activeingredient_name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_name_type'
        db.add_column('indivo_medication', 'activeingredient_name_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_name_value'
        db.add_column('indivo_medication', 'activeingredient_name_value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_name_abbrev'
        db.add_column('indivo_medication', 'activeingredient_name_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.form'
        db.add_column('indivo_medication', 'form', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.form_type'
        db.add_column('indivo_medication', 'form_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.form_value'
        db.add_column('indivo_medication', 'form_value', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.form_abbrev'
        db.add_column('indivo_medication', 'form_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_textvalue'
        db.add_column('indivo_medication', 'activeingredient_strength_textvalue', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_value'
        db.add_column('indivo_medication', 'activeingredient_strength_value', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_unit'
        db.add_column('indivo_medication', 'activeingredient_strength_unit', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_unit_type'
        db.add_column('indivo_medication', 'activeingredient_strength_unit_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_unit_value'
        db.add_column('indivo_medication', 'activeingredient_strength_unit_value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Medication.activeingredient_strength_unit_abbrev'
        db.add_column('indivo_medication', 'activeingredient_strength_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_unit'
        db.add_column('indivo_medication', 'amount_ordered_unit', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_textvalue'
        db.add_column('indivo_medication', 'amount_ordered_textvalue', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_value'
        db.add_column('indivo_medication', 'amount_ordered_value', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_unit_type'
        db.add_column('indivo_medication', 'amount_ordered_unit_type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_unit_value'
        db.add_column('indivo_medication', 'amount_ordered_unit_value', self.gf('django.db.models.fields.CharField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Medication.amount_ordered_unit_abbrev'
        db.add_column('indivo_medication', 'amount_ordered_unit_abbrev', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Medication.refills'
        db.add_column('indivo_medication', 'refills', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Medication.substitution_permitted'
        db.add_column('indivo_medication', 'substitution_permitted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Medication.instructions'
        db.add_column('indivo_medication', 'instructions', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'Medication.reason_stopped'
        db.add_column('indivo_medication', 'reason_stopped', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Changing field 'Medication.name'
        db.alter_column('indivo_medication', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        db.add_column('indivo_medication', 'dispense_as_written', self.gf('django.db.models.fields.NullBooleanField')(null=True), keep_default=False)
        ...
        # Deleting field 'Medication.datetime_started'
        db.delete_column('indivo_medication', 'datetime_started')

        # Deleting field 'Medication.datetime_stopped'
        db.delete_column('indivo_medication', 'datetime_stopped')

        # Deleting field 'Medication.order_type'
        db.delete_column('indivo_medication', 'order_type')

        # Deleting field 'Medication.ordered_by'
        db.delete_column('indivo_medication', 'ordered_by')

        # Deleting field 'Medication.datetime_ordered'
        db.delete_column('indivo_medication', 'datetime_ordered')

        # Deleting field 'Medication.datetime_expires'
        db.delete_column('indivo_medication', 'datetime_expires')

        # Deleting field 'Medication.indication'
        db.delete_column('indivo_medication', 'indication')

        # Deleting field 'Medication.activeingredient_name'
        db.delete_column('indivo_medication', 'activeingredient_name')

        # Deleting field 'Medication.activeingredient_name_type'
        db.delete_column('indivo_medication', 'activeingredient_name_type')

        # Deleting field 'Medication.activeingredient_name_value'
        db.delete_column('indivo_medication', 'activeingredient_name_value')

        # Deleting field 'Medication.activeingredient_name_abbrev'
        db.delete_column('indivo_medication', 'activeingredient_name_abbrev')

        # Deleting field 'Medication.form'
        db.delete_column('indivo_medication', 'form')

        # Deleting field 'Medication.form_type'
        db.delete_column('indivo_medication', 'form_type')

        # Deleting field 'Medication.form_value'
        db.delete_column('indivo_medication', 'form_value')

        # Deleting field 'Medication.form_abbrev'
        db.delete_column('indivo_medication', 'form_abbrev')

        # Deleting field 'Medication.activeingredient_strength_textvalue'
        db.delete_column('indivo_medication', 'activeingredient_strength_textvalue')

        # Deleting field 'Medication.activeingredient_strength_value'
        db.delete_column('indivo_medication', 'activeingredient_strength_value')

        # Deleting field 'Medication.activeingredient_strength_unit'
        db.delete_column('indivo_medication', 'activeingredient_strength_unit')

        # Deleting field 'Medication.activeingredient_strength_unit_type'
        db.delete_column('indivo_medication', 'activeingredient_strength_unit_type')

        # Deleting field 'Medication.activeingredient_strength_unit_value'
        db.delete_column('indivo_medication', 'activeingredient_strength_unit_value')

        # Deleting field 'Medication.activeingredient_strength_unit_abbrev'
        db.delete_column('indivo_medication', 'activeingredient_strength_unit_abbrev')

        # Deleting field 'Medication.amount_ordered_unit'
        db.delete_column('indivo_medication', 'amount_ordered_unit')

        # Deleting field 'Medication.amount_ordered_textvalue'
        db.delete_column('indivo_medication', 'amount_ordered_textvalue')

        # Deleting field 'Medication.amount_ordered_value'
        db.delete_column('indivo_medication', 'amount_ordered_value')

        # Deleting field 'Medication.amount_ordered_unit_type'
        db.delete_column('indivo_medication', 'amount_ordered_unit_type')

        # Deleting field 'Medication.amount_ordered_unit_value'
        db.delete_column('indivo_medication', 'amount_ordered_unit_value')

        # Deleting field 'Medication.amount_ordered_unit_abbrev'
        db.delete_column('indivo_medication', 'amount_ordered_unit_abbrev')

        # Deleting field 'Medication.refills'
        db.delete_column('indivo_medication', 'refills')

        # Deleting field 'Medication.substitution_permitted'
        db.delete_column('indivo_medication', 'substitution_permitted')

        # Deleting field 'Medication.instructions'
        db.delete_column('indivo_medication', 'instructions')

        # Deleting field 'Medication.reason_stopped'
        db.delete_column('indivo_medication', 'reason_stopped')

        # User chose to not deal with backwards NULL issues for 'Medication.name'
        raise RuntimeError("Cannot reverse this migration. 'Medication.name' and its values cannot be restored.")
